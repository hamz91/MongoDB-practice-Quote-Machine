...
var _Header = __webpack_require__(/*! ./Header */ "./src/compnents/Header.js");

var _Header2 = _interopRequireDefault(_Header);

var _QuotesForm = __webpack_require__(/*! ./QuotesForm */ "./src/compnents/QuotesForm.js");

var _QuotesForm2 = _interopRequireDefault(_QuotesForm);

var _QuotesDisplay = __webpack_require__(/*! ./QuotesDisplay */ "./src/compnents/QuotesDisplay.js");

var _QuotesDisplay2 = _interopRequireDefault(_QuotesDisplay);
...
var QuotesForm = function (_React$Component) {
  _inherits(QuotesForm, _React$Component);

  function QuotesForm() {
    _classCallCheck(this, QuotesForm);

    var _this = _possibleConstructorReturn(this, (QuotesForm.__proto__ || Object.getPrototypeOf(QuotesForm)).call(this));
    ...
    _this.movieChange = _this.movieChange.bind(_this);
    _this.characterChange = _this.characterChange.bind(_this);
    _this.quoteChange = _this.quoteChange.bind(_this);
    _this.handleSubmit = _this.handleSubmit.bind(_this);
    return _this;
  }

  _createClass(QuotesForm, [{
    key: "movieChange",
    value: function movieChange(event) {
      this.setState({
    ...
    key: "characterChange",
    value: function characterChange(event) {
      this.setState({
    ...
    key: "quoteChange",
    value: function quoteChange(event) {
      this.setState({
...
var _App = __webpack_require__(/*! ./compnents/App */ "./src/compnents/App.js");
